...
?>
<h5>Please choose products category that you interested in</h5><br />
...
<a style="width:100%" href="<?PHP create_link(8,3,1,-1);?>">Material handling equipment</a></h5><br />
<div style="width:100%;text-align:center">
<?PHP 
...
<div class="clear"></div></div><br />
<h5 style="border-style:outset;font-size:larger" >
<a style="width:100%" href="<?PHP create_link(8,3,2,-1);?>">Hook-on attachments</a></h5><br />
